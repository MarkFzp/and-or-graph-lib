!function () {
    ...
    function h(t) {
        return t > 1 ? fa / 2 : -1 > t ? -fa / 2 : Math.asin(t)
    }
    ...
    function s(t) {
        function n(t, n) {
            var a = Math.cos(t), e = Math.cos(n), o = Math.sin(n), i = e * a,
    ...
    function c() {
        var t = fa / 2, n = ba(s), a = n(t);
        return a.radius = function (a) {
            return arguments.length ? n(t = a * fa / 180) : 180 * (t / fa)
        }, a
    }
    ...
    function v(t) {
        ...
        return n.invert = function (t, n) {
            var h = 0, u = 0, M = 50;
            do {
                var s = Math.cos(h), c = Math.sin(h), f = Math.cos(u), v = Math.sin(u), l = 1 + f, g = l * c - t,
                    d = i + v * r - l * a * s - n, b = .5 * l * s, p = -c * v, w = .5 * a * l * c,
                    q = r * f + a * s * v, m = p * w - q * b, y = .5 * (d * p - g * q) / m, S = (g * w - d * b) / m;
                h -= y, u -= S
    ...
    function l() {
        var t = fa / 9, n = t > 0 ? 1 : -1, a = Math.tan(n * t), r = ba(v), e = r(t), o = e.stream;
        return e.parallel = function (e) {
            return arguments.length ? (a = Math.tan((n = (t = e * fa / 180) > 0 ? 1 : -1) * t), r(t)) : 180 * (t / fa)
        }, e.stream = function (r) {
            ...
            return e.rotate(i), h.sphere = function () {
                ...
                for (; n * (r -= t) >= -180;)u.point(r, n * -Math.atan2(Math.cos(r * la / 2), a) * ga);
    ...
    function q(t, n) {
        var a = Math.tan(n / 2), r = M(1 - a * a), e = 1 + r * Math.cos(t /= 2), o = Math.sin(t) * r / e, i = a / e,
            h = o * o, u = i * i;
    ...
    function y(t) {
        function n(t, n) {
            var r = wa(t, n);
            if (Math.abs(t) > fa / 2) {
                var e = Math.atan2(r[1], r[0]), o = Math.sqrt(r[0] * r[0] + r[1] * r[1]),
                    i = a * Math.round((e - fa / 2) / a) + fa / 2, u = Math.atan2(Math.sin(e -= i), 2 - Math.cos(e));
        ...
        return n.invert = function (t, n) {
            ...
            if (r > fa / 2) {
                var e = Math.atan2(n, t), o = a * Math.round((e - fa / 2) / a) + fa / 2, i = e > o ? -1 : 1,
                    h = r * Math.cos(o - e),
                    u = 1 / Math.tan(i * Math.acos((h - fa) / Math.sqrt(fa * (fa - 2 * h) + r * r)));
                e = o + 2 * Math.atan((u + i * Math.sqrt(u * u - 3)) / 3), t = r * Math.cos(e), n = r * Math.sin(e)
            }
            return wa.invert(t, n)
        }, n
    }

    function S() {
        var t = 5, n = ba(y), a = n(t), r = a.stream;
        return a.lobes = function (a) {
            return arguments.length ? n(t = +a) : t
        }, a.stream = function (n) {
            var e = a.rotate(), o = r(n), i = (a.rotate([0, 0]), r(n));
            return a.rotate(e), o.sphere = function () {
                i.polygonStart(), i.lineStart();
                for (var n = .01, a = 0, r = 360 / t, e = 90 - 180 / t; t > a; ++a, e -= r)i.point(180, 0), -90 > e ? (i.point(-90, 180 - e - n), i.point(-90, 180 - e + n)) : (i.point(90, e + n), i.point(90, e - n));
                i.lineEnd(), i.polygonEnd()
            }, o
        }, a
    }
    ...
    function k(t) {
        ...
        var o = B(t[0].v[0], t[2].v[0], t[1].v[0]), i = B(t[0].v[0], t[1].v[0], t[2].v[0]), h = fa - o;
    ...
    function _() {
        var t = [[0, 0], [0, 0], [0, 0]], n = ba(k), a = n(t), r = a.rotate;
    ...
    function A(t) {
        return [t[0] * la, t[1] * la]
    }

    function G(t, n) {
        var a = M(1 - Math.sin(n));
        return [2 / va * t * a, va * (1 - a)]
    }
    ...
    function C(t, n) {
        var a = Math.sqrt(3);
        return [a * t * (2 * Math.cos(2 * n / 3) - 1) / va, a * va * Math.sin(n / 3)]
    }
    ...
    function N(t, n) {
        for (var a = (1 + fa / 2) * Math.sin(n), r = 0, e = 1 / 0; 10 > r && Math.abs(e) > sa; r++)n -= e = (n + Math.sin(n) - a) / (1 + Math.cos(n));
        return a = Math.sqrt(2 + fa), [t * (1 + Math.cos(n)) / a, 2 * n / a]
    }

    function U(t, n) {
        var a = Math.sin(t /= 2), r = Math.cos(t), e = Math.sqrt(Math.cos(n)), o = Math.cos(n /= 2),
            i = Math.sin(n) / (o + Math.SQRT2 * r * e), h = Math.sqrt(2 / (1 + i * i)),
            u = Math.sqrt((Math.SQRT2 * o + (r + a) * e) / (Math.SQRT2 * o + (r - a) * e));
        return [Sa * (h * (u - 1 / u) - 2 * Math.log(u)), Sa * (h * i * (u + 1 / u) - 2 * Math.atan(i))]
    }

    function V(t, n) {
        var a = Math.tan(n / 2);
        return [t * Qa * M(1 - a * a), (1 + Qa) * a]
    }

    function W(t, n) {
        var a = n / 2, r = Math.cos(a);
        return [2 * t / va * Math.cos(n) * r * r, va * Math.tan(a)]
    }

    function X(t, n, a, r, e, o, i, h) {
        function u(u, M) {
            if (!M)return [t * u / fa, 0];
            var s = M * M, c = t + s * (n + s * (a + s * r)), f = M * (e - 1 + s * (o - h + s * i)),
                v = (c * c + f * f) / (2 * f), l = u * Math.asin(c / v) / fa;
            return [v * Math.sin(l), M * (1 + s * h) + v * (1 - Math.cos(l))]
        }

        return arguments.length < 8 && (h = 0), u.invert = function (u, s) {
            var c, f, v = fa * u / t, l = s, g = 50;
            do {
                var d = l * l, b = t + d * (n + d * (a + d * r)), p = l * (e - 1 + d * (o - h + d * i)),
                    w = b * b + p * p, q = 2 * p, m = w / q, y = m * m, S = Math.asin(b / m) / fa, Q = v * S;
    ...
    function Z(t) {
        ...
        function a(n) {
            var a = n ? function (n, a) {
                var e = Math.abs(n) < fa / 2, o = t(e ? n : n > 0 ? n - fa : n + fa, a),
                    h = (o[0] - o[1]) * Math.SQRT1_2, u = (o[0] + o[1]) * Math.SQRT1_2;
                if (e)return [h, u];
                var M = r * Math.SQRT1_2, s = h > 0 ^ u > 0 ? -1 : 1;
                return [s * h - i(u) * M, s * u - i(h) * M]
            } : function (n, a) {
                var e = n > 0 ? -.5 : .5, o = t(n + e * fa, a);
                return o[0] -= e * r, o
            };
            return t.invert && (a.invert = n ? function (n, a) {
                var e = (n + a) * Math.SQRT1_2, o = (a - n) * Math.SQRT1_2,
                    i = Math.abs(e) < .5 * r && Math.abs(o) < .5 * r;
                if (!i) {
                    var h = r * Math.SQRT1_2, u = e > 0 ^ o > 0 ? -1 : 1, M = -u * (n + (o > 0 ? 1 : -1) * h),
                        s = -u * (a + (e > 0 ? 1 : -1) * h);
                ...
                var e = n > 0 ? -.5 : .5, o = t.invert(n + e * r, a), i = o[0] - e * fa;
                return -fa > i ? i += 2 * fa : i > fa && (i -= 2 * fa), o[0] = i, o
            }), a
        }

        var r = t(fa / 2, 0)[0] - t(-fa / 2, 0)[0];
        return n.raw = a, n
    }

    function $(t, n) {
        var a = i(t), r = i(n), e = Math.cos(n), o = Math.cos(t) * e, u = Math.sin(t) * e, M = Math.sin(r * n);
        t = Math.abs(Math.atan2(u, M)), n = h(o), Math.abs(t - fa / 2) > sa && (t %= fa / 2);
        var s = tn(t > fa / 4 ? fa / 2 - t : t, n);
        return t > fa / 4 && (M = s[0], s[0] = -s[1], s[1] = -M), s[0] *= a, s[1] *= -r, s
    }

    function tn(t, n) {
        if (n === fa / 2)return [0, 0];
        var a = Math.sin(n), r = a * a, e = r * r, o = 1 + e, i = 1 + 3 * e, u = 1 - e, s = h(1 / Math.sqrt(o)),
            c = u + r * o * s, f = (1 - a) / c, v = Math.sqrt(f), l = f * o, g = Math.sqrt(l), d = v * u;
        if (0 === t)return [0, -(d + r * g)];
        var b = Math.cos(n), p = 1 / b, w = 2 * a * b, q = (-3 * r + s * i) * w, m = (-c * b - (1 - a) * q) / (c * c),
            y = .5 * m / v, S = u * y - 2 * r * v * w, Q = r * o * m + f * i * w, R = -p * w, T = -p * Q,
            x = -2 * p * S, E = 4 * t / fa;
        if (t > .222 * fa || fa / 4 > n && t > .175 * fa) {
            ...
            P = .5 * (_ + k);
            do {
                var B = Math.sqrt(l - P * P), F = P * (x + R * B) + T * h(P / g) - E;
                if (!F)break;
                0 > F ? _ = P : k = P, P = .5 * (_ + k)
            ...
            var A, P = sa, z = 25;
            do {
                var G = P * P, B = M(l - G), j = x + R * B, F = P * j + T * h(P / g) - E, C = j + (T - R * G) / B;
                P -= A = B ? F / C : 0
    ...
    function nn(t, n) {
        for (var a = 0, r = 1, e = .5, o = 50; ;) {
            var i = e * e, h = Math.sqrt(e), u = Math.asin(1 / Math.sqrt(1 + i)), M = 1 - i + e * (1 + i) * u,
                s = (1 - h) / M, c = Math.sqrt(s), f = s * (1 + i), v = c * (1 - i), l = f - t * t, g = Math.sqrt(l),
                d = n + v + e * g;
            if (Math.abs(r - a) < ca || 0 === --o || 0 === d)break;
            d > 0 ? a = e : r = e, e = .5 * (a + r)
        }
        if (!o)return null;
        var b = Math.asin(h), p = Math.cos(b), w = 1 / p, q = 2 * h * p, m = (-3 * e + u * (1 + 3 * i)) * q,
            y = (-M * p - (1 - h) * m) / (M * M), S = .5 * y / c, Q = (1 - i) * S - 2 * e * c * q, R = -2 * w * Q,
            T = -w * q, x = -w * (e * (1 + i) * y + s * (1 + 3 * i) * q);
    ...
    function an(t, n, a) {
        ...
        var r = rn(n, 1 - a), o = r[1] * r[1] + a * e[0] * e[0] * r[0] * r[0];
    ...
    function rn(t, n) {
        ...
        if (n >= 1 - sa)return a = .25 * (1 - n), r = b(t), o = g(t), e = 1 / r, i = r * d(t), [o + a * (i - t) / (r * r), e - a * o * e * (i - t), e + a * o * e * (i + t), 2 * Math.atan(Math.exp(t)) - fa / 2 + a * (i - t) / r];
    ...
    function en(t, n, a) {
        ...
        if (r) {
            var h = 1 / Math.sin(r), u = 1 / (Math.tan(r) * Math.tan(r)), s = -(u + a * o * o * h * h - 1 + a),
                c = (a - 1) * u, f = .5 * (-s + Math.sqrt(s * s - 4 * c));
    ...
    function hn(t, n) {
        var a = (Math.SQRT2 - 1) / (Math.SQRT2 + 1), r = Math.sqrt(1 - a * a), e = on(fa / 2, r * r), o = -1,
            h = Math.log(Math.tan(fa / 4 + Math.abs(n) / 2)), u = Math.exp(o * h) / Math.sqrt(a),
            M = un(u * Math.cos(o * t), u * Math.sin(o * t)), s = en(M[0], M[1], r * r);
        return [-s[1], i(n) * (.5 * e - s[0])]
    }

    function un(t, n) {
        var a = t * t, r = n + 1, e = 1 - a - n * n;
        return [i(t) * fa / 4 - .5 * Math.atan2(e, 2 * t), -.25 * Math.log(e * e + 4 * a) + .5 * Math.log(r * r + a)]
    }
    ...
    function sn(t) {
        function n(t, n) {
            var o = e(t, n);
            t = o[0], n = o[1];
            var i = Math.sin(n), h = Math.cos(n), M = Math.cos(t), s = u(a * i + r * h * M), c = Math.sin(s),
                f = Math.abs(c) > sa ? s / c : 1;
            return [f * r * Math.sin(t), (Math.abs(t) > fa / 2 ? f : -f) * (a * h - r * i * M)]
        }

        var a = Math.sin(t), r = Math.cos(t), e = cn(t);
        return e.invert = cn(-t), n.invert = function (t, n) {
            var r = Math.sqrt(t * t + n * n), o = -Math.sin(r), i = Math.cos(r), h = r * i, u = -n * o, s = r * a,
                c = M(h * h + u * u - s * s), f = Math.atan2(h * s + u * c, u * s - h * c),
                v = (r > fa / 2 ? -1 : 1) * Math.atan2(t * o, r * Math.cos(f) * i + n * Math.sin(f) * o);
            return e.invert(v, f)
        }, n
    }
    ...
    function fn() {
        var t = 0, n = ba(sn), a = n(t), r = a.rotate, e = a.stream, o = d3.geo.circle();
        return a.parallel = function (r) {
            if (!arguments.length)return 180 * (t / fa);
            var e = a.rotate();
            return n(t = r * fa / 180).rotate(e)
        }, a.rotate = function (n) {
            return arguments.length ? (r.call(a, [n[0], n[1] - 180 * (t / fa)]), o.origin([-n[0], -n[1]]), a) : (n = r.call(a), n[1] += 180 * (t / fa), n)
        }, a.stream = function (t) {
    ...
    function vn(t, n) {
        ...
        return arguments.length < 2 && (n = t), 1 === n ? Pa : 1 / 0 === n ? gn : (a.invert = function (a, r) {
            var e = Pa.invert(a / t, r);
            return e[0] *= n, e
        }, a)
    }

    function ln() {
        var t = 2, n = ba(vn), a = n(t);
    ...
    function bn(t) {
        ...
        var a = d3.geo.cylindricalEqualArea.raw(0), r = ka * fa / 180, e = 2 * fa,
            o = d3.geo.collignon.raw(fa, r)[0] - d3.geo.collignon.raw(-fa, r)[0], i = a(0, r)[1],
            h = d3.geo.collignon.raw(0, r)[1], u = d3.geo.collignon.raw(0, fa / 2)[1] - h, M = 2 * fa / t;
        return n.invert = function (n, r) {
            n *= 2;
            var s = Math.abs(r);
            if (s > i) {
    ...
    function pn() {
        ...
        var n = 2, a = ba(bn), r = a(n), e = r.stream;
    ...
    function wn(t) {
        ...
        var a, r = 1 + t, e = Math.sin(1 / r), o = h(e), i = 2 * Math.sqrt(fa / (a = fa + 4 * o * r)),
            M = .5 * i * (r + Math.sqrt(t * (2 + t))), s = t * t, c = r * r;
        return n.invert = function (t, n) {
            var e = t * t + (n -= M) * n, f = (1 + c - e / (i * i)) / (2 * r), v = u(f), l = Math.sin(v),
    ...
    function mn(t, n) {
        return n > -_a ? (t = ma(t, n), t[1] += za, t) : E(t, n)
    }

    function yn(t, n) {
        return Math.abs(n) > _a ? (t = ma(t, n), t[1] -= n > 0 ? za : -za, t) : E(t, n)
    }
    ...
    function Qn(t) {
        function n(n, a) {
            if (Math.abs(Math.abs(a) - fa / 2) < sa)return [0, 0 > a ? -2 : 2];
        ...
        return n.invert = function (n, a) {
            var r = Math.abs(a);
            if (Math.abs(r - 2) < sa)return n ? null : [0, i(a) * fa / 2];
            if (r > 2)return null;
            n /= 2, a /= 2;
    ...
    function Pn(t) {
        function n(n, e) {
            var o = e - t,
                i = Math.abs(o) < sa ? n * a : Math.abs(i = fa / 4 + e / 2) < sa || Math.abs(Math.abs(i) - fa / 2) < sa ? 0 : n * o / Math.log(Math.tan(i) / r);
            return [i, o]
        }

        var a = Math.cos(t), r = Math.tan(fa / 4 + t / 2);
        return n.invert = function (n, e) {
            var o, i = e + t;
            return [Math.abs(e) < sa ? n / a : Math.abs(o = fa / 4 + i / 2) < sa || Math.abs(Math.abs(o) - fa / 2) < sa ? 0 : n * Math.log(Math.tan(o) / r) / e, i]
        }, n
    }
    ...
    function zn() {
        var t = Ba.miller, n = ba(_n), a = n(t);
        return a.coefficients = function (a) {
            return arguments.length ? n(t = "string" == typeof a ? Ba[a] : a) : t
        }, a
    }
    ...
    function Ln(t, n) {
        var a, r = Math.min(18, 36 * Math.abs(n) / fa), e = Math.floor(r), o = r - e, i = (a = Aa[e])[0], h = a[1],
            u = (a = Aa[++e])[0], M = a[1], s = (a = Aa[Math.min(19, ++e)])[0], c = a[1];
        return [t * (u + o * (s - i) / 2 + o * o * (s - 2 * u + i) / 2), (n > 0 ? fa : -fa) / 2 * (M + o * (c - h) / 2 + o * o * (c - 2 * M + h) / 2)]
    }
    ...
    function Jn(t, n) {
        var a = Math.tan(n / 2), r = Math.sin(fa / 4 * a);
    ...
    function Kn(t) {
        ...
        return n.invert = function (t, n) {
            var e, h, M = n * n, s = Math.cos(Math.sqrt(M + (e = t + a) * e)),
    ...
    function Nn() {
        var t = [[0, 0], [0, 0]], n = ba(Kn), a = n(0), r = a.rotate;
        return delete a.rotate, a.points = function (a) {
            if (!arguments.length)return t;
            t = a;
            var e = d3.geo.interpolate(a[0], a[1]), o = e(.5), i = d3.geo.rotation([-o[0], -o[1]])(a[0]),
                u = .5 * e.distance, M = (i[0] < 0 ? -1 : 1) * i[1] * la, s = h(Math.sin(M) / Math.sin(u));
            return r.call(i, [-o[0], -o[1], -s * ga]), n(2 * u)
        }, a
    }
    ...
    function Vn() {
        var t = [[0, 0], [0, 0]], n = ba(Un), a = n(0), r = a.rotate;
        return delete a.rotate, a.points = function (a) {
            if (!arguments.length)return t;
            t = a;
            var e = d3.geo.interpolate(a[0], a[1]), o = e(.5), i = d3.geo.rotation([-o[0], -o[1]])(a[0]),
                u = .5 * e.distance, M = (i[0] < 0 ? -1 : 1) * i[1] * la, s = h(Math.sin(M) / Math.sin(u));
            return r.call(i, [-o[0], -o[1], -s * ga]), n(u)
        }, a
    }

    function Wn(t, n) {
        if (Math.abs(n) < sa)return [t, 0];
        var a = Math.abs(2 * n / fa), r = h(a);
        if (Math.abs(t) < sa || Math.abs(Math.abs(n) - fa / 2) < sa)return [0, i(n) * fa * Math.tan(r / 2)];
        var e = Math.cos(r), o = Math.abs(fa / t - t / fa) / 2, u = o * o, M = e / (a + e - 1), s = M * (2 / a - 1),
            c = s * s, f = c + u, v = M - c, l = u + M;
    ...
    function Xn(t, n) {
        ...
        var a = Math.abs(2 * n / fa), r = h(a);
        if (Math.abs(t) < sa || Math.abs(Math.abs(n) - fa / 2) < sa)return [0, i(n) * fa * Math.tan(r / 2)];
        var e = Math.cos(r), o = Math.abs(fa / t - t / fa) / 2, u = o * o,
    ...
    function Yn(t, n) {
        if (Math.abs(n) < sa)return [t, 0];
        var a = 2 * n / fa, r = h(a);
        if (Math.abs(t) < sa || Math.abs(Math.abs(n) - fa / 2) < sa)return [0, fa * Math.tan(r / 2)];
        var e = (fa / t - t / fa) / 2, o = a / (1 + Math.cos(r));
    ...
    function Zn(t, n) {
        if (!n)return [t, 0];
        var a = Math.abs(n);
        if (!t || a === fa / 2)return [0, n];
        var r = 2 * a / fa, e = r * r, o = (8 * r - e * (e + 2) - 5) / (2 * e * (r - 1)), h = o * o, u = r * o,
            s = e + h + 2 * u, c = r + 3 * o, f = 2 * t / fa, v = f + 1 / f,
            l = i(Math.abs(t) - fa / 2) * Math.sqrt(v * v - 4), g = l * l,
            d = s * (e + h * g - 1) + (1 - e) * (e * (c * c + 4 * h) + 12 * u * h + 4 * h * h),
            b = (l * (s + h - 1) + 2 * M(d)) / (4 * s + g);
        return [i(t) * fa * b / 2, i(n) * fa / 2 * M(1 + l * Math.abs(b) - b * b)]
    }
    ...
    function na(t, n) {
        var a = Math.cos(n), r = Math.cos(t) * a, e = 1 - r,
            o = Math.cos(t = Math.atan2(Math.sin(t) * a, -Math.sin(n))), i = Math.sin(t);
        return a = M(1 - r * r), [i * a - o * e, -o * a - i * e]
    }

    function aa(t, n) {
        var a = f(t, n);
        return [(a[0] + 2 * t / fa) / 2, (a[1] + n) / 2]
    }
    ...
    var ra = {
            ...
            point: function (t, n) {
                ...
                var t = ea.length ? ea.length < 2 ? {type: "Point", coordinates: ea[0]} : {
                    type: "MultiPoint",
                    coordinates: ea
                } : null;
                return ea = [], t
            ...
            lineStart: a, point: function (t, n) {
                ...
                var t = oa.length ? oa.length < 2 ? {type: "LineString", coordinates: oa[0]} : {
            ...
            polygonStart: a, lineStart: a, point: function (t, n) {
                ...
                }), oa = [], t.length ? t.length > 1 ? {type: "MultiPolygon", coordinates: t} : {
                    type: "Polygon",
                    coordinates: t[0]
                } : null
            }
        }, Ma = {Point: ia, MultiPoint: ia, LineString: ha, MultiLineString: ha, Polygon: ua, MultiPolygon: ua}, sa = 1e-6,
        ca = sa * sa, fa = Math.PI, va = Math.sqrt(fa), la = fa / 180, ga = 180 / fa, da = d3.geo.projection,
        ba = d3.geo.projectionMutator;
    d3.geo.interrupt = function (t) {
        ...
        function a() {
            i = h.map(function (n) {
                return n.map(function (n) {
                    var a, r = t(n[0][0], n[0][1])[0], e = t(n[2][0], n[2][1])[0], o = t(n[1][0], n[0][1])[1],
                        i = t(n[1][0], n[1][1])[1];
        ...
        function r() {
            for (var t = 1e-6, n = [], a = 0, r = h[0].length; r > a; ++a) {
                var o = h[0][a], i = 180 * o[0][0] / fa, u = 180 * o[0][1] / fa, M = 180 * o[1][1] / fa,
                    s = 180 * o[2][0] / fa, c = 180 * o[2][1] / fa;
                n.push(e([[i + t, u + t], [i + t, M - t], [s - t, M - t], [s - t, c + t]], 30))
            }
            for (var a = h[1].length - 1; a >= 0; --a) {
                var o = h[1][a], i = 180 * o[0][0] / fa, u = 180 * o[0][1] / fa, M = 180 * o[1][1] / fa,
                    s = 180 * o[2][0] / fa, c = 180 * o[2][1] / fa;
        ...
        var i, h = [[[[-fa, 0], [0, fa / 2], [fa, 0]]], [[[-fa, 0], [0, -fa / 2], [fa, 0]]]];
        ...
        var a = t, r = n, e = 25;
        do {
            var o, i = Math.sin(a), h = Math.sin(a / 2), M = Math.cos(a / 2), s = Math.sin(r), c = Math.cos(r),
                f = Math.sin(2 * r), v = s * s, l = c * c, g = h * h, d = 1 - l * M * M,
                b = d ? u(c * M) * Math.sqrt(o = 1 / d) : o = 0, p = 2 * b * c * h - t, w = b * s - n,
                q = o * (l * g + b * c * M * v), m = o * (.5 * i * f - 2 * b * s * h),
                y = .25 * o * (f * h - b * s * l * i), S = o * (v * M + b * g * c), Q = m * y - S * q;
            if (!Q)break;
        ...
        var a = t * t, r = n * n, e = 1 + a + r, o = Math.sqrt(.5 * (e - Math.sqrt(e * e - 4 * n * n))), u = h(o) / 3,
            M = o ? w(Math.abs(n / o)) / 3 : p(Math.abs(t)) / 3, s = Math.cos(u), c = b(M), f = c * c - s * s;
        return [2 * i(t) * Math.atan2(d(M) * s, .25 - f), 2 * i(n) * Math.atan2(c * Math.sin(u), .25 + f)]
    }, (d3.geo.august = function () {
        return da(q)
    }).raw = q;
    var pa = Math.log(1 + Math.SQRT2);
    m.invert = function (t, n) {
        if ((r = Math.abs(n)) < pa)return [t, 2 * Math.atan(Math.exp(n)) - fa / 2];
    ...
    var wa = d3.geo.azimuthalEquidistant.raw;
    (d3.geo.berghaus = S).raw = y;
    var qa = Q(fa), ma = R(2 * Math.SQRT2 / fa, Math.SQRT2, fa);
    (d3.geo.mollweide = function () {
        return da(ma)
    }).raw = ma, T.invert = function (t, n) {
    ...
    (d3.geo.bromley = function () {
        return da(ya)
    }).raw = ya, (d3.geo.chamberlin = _).raw = k, G.invert = function (t, n) {
        var a = (a = n / va - 1) * a;
        ...
        var a = Math.sqrt(3), r = 3 * h(n / (a * va));
        return [va * t / (a * (2 * Math.cos(2 * r / 3) - 1)), r]
        ...
        return [t / (2 / Math.sqrt(fa * (4 + fa)) * (1 + e)), h((r + a * (e + 2)) / (2 + fa / 2))]
        ...
        t /= Sa, n /= Sa;
        do {
            var i = r / 2, h = e / 2, u = Math.sin(i), M = Math.cos(i), s = Math.sin(h), c = Math.cos(h),
                f = Math.cos(e), v = Math.sqrt(f), l = s / (c + Math.SQRT2 * M * v), g = l * l,
                d = Math.sqrt(2 / (1 + g)), b = Math.SQRT2 * c + (M + u) * v, p = Math.SQRT2 * c + (M - u) * v,
                w = b / p, q = Math.sqrt(w), m = q - 1 / q, y = q + 1 / q, S = d * m - 2 * Math.log(q) - t,
                Q = d * l * y - 2 * Math.atan(l) - n, R = s && Math.SQRT1_2 * v * u * g / s,
                T = (Math.SQRT2 * M * c + v) / (2 * (c + Math.SQRT2 * M * v) * (c + Math.SQRT2 * M * v) * v),
                x = -.5 * l * d * d * d, E = x * R, P = x * T, k = (k = 2 * c + Math.SQRT2 * v * (M - u)) * k * q,
                _ = (Math.SQRT2 * M * c * v + f) / k, z = -(Math.SQRT2 * u * s) / (v * k),
                B = m * E - 2 * _ / q + d * (_ + _ / w), F = m * P - 2 * z / q + d * (z + z / w),
                A = l * y * E - 2 * R / (1 + g) + d * y * R + d * l * (_ - _ / w),
                G = l * y * P - 2 * T / (1 + g) + d * y * T + d * l * (z - z / w), j = F * A - G * B;
            if (!j)break;
            var C = (Q * F - S * G) / j, D = (S * A - Q * B) / j;
            r -= C, e = Math.max(-fa / 2, Math.min(fa / 2, e - D))
        } while ((Math.abs(C) > sa || Math.abs(D) > sa) && --o > 0);
        return Math.abs(Math.abs(e) - fa / 2) < sa ? [0, e] : o && [r, e]
    };
    var Sa = 3 + 2 * Math.SQRT2;
    (d3.geo.eisenlohr = function () {
        return da(U)
    }).raw = U, V.invert = function (t, n) {
        var a = n / (1 + Qa);
        return [t ? t / (Qa * M(1 - a * a)) : 0, 2 * Math.atan(a)]
    };
    var Qa = Math.cos(35 * la);
    (d3.geo.fahey = function () {
        return da(V)
    }).raw = V, W.invert = function (t, n) {
        var a = Math.atan(n / va), r = Math.cos(a), e = 2 * a;
        return [.5 * t * va / (Math.cos(e) * r * r), e]
    }, (d3.geo.foucaut = function () {
        return da(W)
    }).raw = W, d3.geo.gilbert = function (t) {
        function n(n) {
            return t([.5 * n[0], h(Math.tan(.5 * n[1] * la)) * ga])
        }

        var a = d3.geo.equirectangular().scale(ga).translate([0, 0]);
        return t.invert && (n.invert = function (n) {
            return n = t.invert(n), n[0] *= 2, n[1] = 2 * Math.atan(Math.sin(n[1] * la)) * ga, n
        }), n.stream = function (n) {
            n = t.stream(n);
            var r = a.stream({
                point: function (t, a) {
                    n.point(.5 * t, h(Math.tan(.5 * -a * la)) * ga)
                }, lineStart: function () {
                    n.lineStart()
                }, lineEnd: function () {
                    n.lineEnd()
    ...
    var Ra = X(2.8284, -1.6988, .75432, -.18071, 1.76003, -.38914, .042555);
    (d3.geo.ginzburg4 = function () {
        return da(Ra)
    }).raw = Ra;
    var Ta = X(2.583819, -.835827, .170354, -.038094, 1.543313, -.411435, .082742);
    (d3.geo.ginzburg5 = function () {
        return da(Ta)
    }).raw = Ta;
    var xa = X(5 / 6 * fa, -.62636, -.0344, 0, 1.3493, -.05524, 0, .045);
    (d3.geo.ginzburg6 = function () {
        return da(xa)
    }).raw = xa, Y.invert = function (t, n) {
        var a, r = t, e = n, o = 50;
        do {
            var i = e * e;
    ...
    var Ea = X(2.6516, -.76534, .19123, -.047094, 1.36289, -.13965, .031762);
    (d3.geo.ginzburg9 = function () {
        return da(Ea)
    }).raw = Ea, $.invert = function (t, n) {
        ...
        var a = (Math.SQRT2 - 1) / (Math.SQRT2 + 1), r = Math.sqrt(1 - a * a), e = on(fa / 2, r * r), o = -1,
            i = an(.5 * e - n, -t, r * r), h = Mn(i[0], i[1]), u = Math.atan2(h[1], h[0]) / o;
        return [u, 2 * Math.atan(Math.exp(.5 / o * Math.log(a * h[0] * h[0] + a * h[1] * h[1]))) - fa / 2]
    }, d3.geo.guyou = Z(hn), (d3.geo.hammerRetroazimuthal = fn).raw = sn;
    var Pa = d3.geo.azimuthalEqualArea.raw;
    gn.invert = function (t, n) {
        var a = 2 * h(n / 2);
        return [t * Math.cos(a / 2) / Math.cos(a), a]
    }, (d3.geo.hammer = ln).raw = vn, dn.invert = function (t, n) {
        var a = Math.abs(a = n * (0 > n ? .5179951515653813 : .5686373742600607)) > 1 - sa ? a > 0 ? fa / 2 : -fa / 2 : h(a);
        return [1.1764705882352942 * t / Math.cos(a), Math.abs(a = ((a += a) + Math.sin(a)) * (0 > n ? .4102345310814193 : .3736990601468637)) > 1 - sa ? a > 0 ? fa / 2 : -fa / 2 : h(a)]
    }, (d3.geo.hatano = function () {
        return da(dn)
    }).raw = dn;
    var ka = 41 + 48 / 36 + 37 / 3600;
    (d3.geo.healpix = pn).raw = bn, (d3.geo.hill = qn).raw = wn;
    var _a = .7109889596207567, za = .0528035274542;
    mn.invert = function (t, n) {
        return n > -_a ? ma.invert(t, n - za) : E.invert(t, n)
    }, (d3.geo.sinuMollweide = function () {
        return da(mn).rotate([-20, -55])
    }).raw = mn, yn.invert = function (t, n) {
        return Math.abs(n) > _a ? ma.invert(t, n + (n > 0 ? za : -za)) : E.invert(t, n)
        ...
        var a = Math.abs(t), r = Math.abs(n), e = fa / Math.SQRT2, o = sa, i = fa / 2;
        e > r ? i *= r / e : o += 6 * u(e / r);
        for (var h = 0; 25 > h; h++) {
            var s = Math.sin(i), c = M(Math.cos(i)), f = Math.sin(i / 2), v = Math.cos(i / 2), l = Math.sin(o / 6),
                g = Math.cos(o / 6), d = .5 * o * (1 + c) - a, b = i / (v * g) - r, p = c ? -.25 * o * s / c : 0,
                w = .5 * (1 + c), q = (1 + .5 * i * f / v) / (v * g), m = i / v * (l / 6) / (g * g), y = p * m - q * w,
                S = (d * m - b * w) / y, Q = (b * p - d * q) / y;
        ...
        var a = i(t) * fa, r = n / 2, e = 50;
        do {
            var o = a * a, h = r * r, u = a * r, M = a * (.975534 + h * (-.119161 + o * -.0143059 + h * -.0547009)) - t,
                s = r * (1.00384 + o * (.0802894 + h * -.02855 + 199025e-9 * o) + h * (.0998909 + h * -.0491032)) - n,
                c = .975534 - h * (.119161 + .0143059 * 3 * o + .0547009 * h),
                f = -u * (.238322 + .2188036 * h + .0286118 * o), v = u * (.1605788 + 7961e-7 * o + -0.0571 * h),
                l = 1.00384 + o * (.0802894 + 199025e-9 * o) + h * (3 * (.0998909 - .02855 * o) - .245516 * h),
                g = f * v - l * c, d = (s * f - M * l) / g, b = (M * v - s * c) / g;
            a -= d, r -= b
    ...
    (d3.geo.modifiedStereographic = zn).raw = _n, Bn.invert = function (t, n) {
        ...
        var a = Math.sqrt(6 / (4 + fa)), r = n / a;
        return Math.abs(Math.abs(r) - fa / 2) < sa && (r = 0 > r ? -fa / 2 : fa / 2), [1.5 * t / (a * (.5 + Math.cos(r))), h((r / 2 + Math.sin(r)) / (1 + fa / 4))]
    ...
    (d3.geo.peirceQuincuncial = function () {
        return Fa().quincuncial(!0).rotate([-90, -90, 45]).clipAngle(180 - 1e-6)
    }).raw = Fa.raw, Cn.invert = function (t, n) {
        if (Math.abs(n) < sa)return [t, 0];
        ...
        return M = Math.tan(e), [(Math.abs(n) < Math.abs(e + 1 / M) ? h(t * M) : i(t) * (u(Math.abs(t * M)) + fa / 2)) / Math.sin(e), e]
    }, (d3.geo.polyconic = function () {
        return da(Cn)
    }).raw = Cn, (d3.geo.rectangularPolyconic = function () {
        return x(Dn)
    }).raw = Dn;
    var Aa = [[.9986, -.062], [1, 0], [.9986, .062], [.9954, .124], [.99, .186], [.9822, .248], [.973, .31], [.96, .372], [.9427, .434], [.9216, .4958], [.8962, .5571], [.8679, .6176], [.835, .6769], [.7986, .7346], [.7597, .7903], [.7186, .8435], [.6732, .8936], [.6213, .9394], [.5722, .9761], [.5322, 1]];
    Aa.forEach(function (t) {
        t[1] *= 1.0144
    }), Ln.invert = function (t, n) {
        var a = 2 * n / fa, r = 90 * a, e = Math.min(18, Math.abs(r / 5)), o = Math.max(0, Math.floor(e));
        do {
            var i = Aa[o][1], h = Aa[o + 1][1], u = Aa[Math.min(19, o + 2)][1], M = u - i, s = u - 2 * h + i,
                c = 2 * (Math.abs(a) - h) / M, f = s / M, v = c * (1 - f * c * (1 - 2 * f * c));
            if (v >= 0 || 1 === o) {
                r = (n >= 0 ? 5 : -5) * (v + e);
                var l, g = 50;
                do e = Math.min(18, Math.abs(r) / 5), o = Math.floor(e), v = e - o, i = Aa[o][1], h = Aa[o + 1][1], u = Aa[Math.min(19, o + 2)][1], r -= (l = (n >= 0 ? fa : -fa) / 2 * (h + v * (u - i) / 2 + v * v * (u - 2 * h + i) / 2) - n) * ga; while (Math.abs(l) > ca && --g > 0);
                break
            }
        } while (--o >= 0);
        var d = Aa[o][0], b = Aa[o + 1][0], p = Aa[Math.min(19, o + 2)][0];
        return [t / (b + v * (p - d) / 2 + v * v * (p - 2 * b + d) / 2), r * la]
        ...
        if (Math.abs(n) < sa)return [t, 0];
        if (Math.abs(t) < sa)return [0, fa / 2 * Math.sin(2 * Math.atan(n / fa))];
        var a = (t /= fa) * t, r = (n /= fa) * n, e = a + r, o = e * e, h = -Math.abs(n) * (1 + e), M = h - 2 * r + a,
            s = -2 * h + 1 + 2 * r + o, c = r / s + (2 * M * M * M / (s * s * s) - 9 * h * M / (s * s)) / 27,
            f = (h - M * M / (3 * s)) / s, v = 2 * Math.sqrt(-f / 3), l = u(3 * c / (f * v)) / 3;
        ...
        if (!t)return [0, fa / 2 * Math.sin(2 * Math.atan(n / fa))];
        var a = Math.abs(t / fa), r = (1 - a * a - (n /= fa) * n) / (2 * a), e = r * r, o = Math.sqrt(e + 1);
        return [i(t) * fa * (o - r), i(n) * fa / 2 * Math.sin(2 * Math.atan2(Math.sqrt((1 - 2 * r * a) * (r + o) - a), Math.sqrt(o + r + a)))]
    }, (d3.geo.vanDerGrinten2 = function () {
        return da(Xn)
    }).raw = Xn, Yn.invert = function (t, n) {
        if (!n)return [t, 0];
        var a = n / fa, r = (fa * fa * (1 - a * a) - t * t) / (2 * fa * t);
        return [t ? fa * (i(t) * Math.sqrt(r * r + 1) - r) : 0, fa / 2 * Math.sin(2 * Math.atan(a))]
    }, (d3.geo.vanDerGrinten3 = function () {
        return da(Yn)
    }).raw = Yn, Zn.invert = function (t, n) {
        if (!t || !n)return [t, n];
        n /= fa;
        var a = 2 * i(t) * t / fa, r = (a * a - 1 + 4 * n * n) / Math.abs(a), e = r * r, o = 2 * n, h = 50;
        do {
            var u = o * o, M = (8 * o - u * (u + 2) - 5) / (2 * u * (o - 1)), s = (3 * o - u * o - 10) / (2 * u * o),
                c = M * M, f = o * M, v = o + M, l = v * v, g = o + 3 * M,
                d = l * (u + c * e - 1) + (1 - u) * (u * (g * g + 4 * c) + c * (12 * f + 4 * c)),
                b = -2 * v * (4 * f * c + (1 - 4 * u + 3 * u * u) * (1 + s) + c * (-6 + 14 * u - e + (-8 + 8 * u - 2 * e) * s) + f * (-8 + 12 * u + (-10 + 10 * u - e) * s)),
                p = Math.sqrt(d), w = r * (l + c - 1) + 2 * p - a * (4 * l + e),
                q = r * (2 * M * s + 2 * v * (1 + s)) + b / p - 8 * v * (r * (-1 + c + l) + 2 * p) * (1 + s) / (e + 4 * l);
            o -= δ = w / q
        } while (δ > sa && --h > 0);
        return [i(t) * (Math.sqrt(r * r + 4) + r) * fa / 4, fa / 2 * o]
    ...
    (d3.geo.wagner4 = function () {
        ...
        var a = -.5 * (t * t + n * n), r = Math.sqrt(-a * (2 + a)), e = n * a + t * r, o = t * a - n * r,
            i = Math.sqrt(o * o + e * e);
        ...
        var a = t, r = n, e = 25;
        do {
            var o, i = Math.cos(r), h = Math.sin(r), M = Math.sin(2 * r), s = h * h, c = i * i, f = Math.sin(a),
                v = Math.cos(a / 2), l = Math.sin(a / 2), g = l * l, d = 1 - c * v * v,
                b = d ? u(i * v) * Math.sqrt(o = 1 / d) : o = 0, p = .5 * (2 * b * i * l + 2 * a / fa) - t,
                w = .5 * (b * h + r) - n, q = .5 * o * (c * g + b * i * v * s) + 1 / fa,
                m = o * (f * M / 4 - b * h * l), y = .125 * o * (M * l - b * h * c * f),
                S = .5 * o * (s * v + b * g * i) + .5, Q = m * y - S * q, R = (w * m - p * S) / Q,
                T = (p * y - w * q) / Q;
            a -= R, r -= T
        } while ((Math.abs(R) > sa || Math.abs(T) > sa) && --e > 0);
        return [a, r]
